...
\newfloat{CodeFloat}{h!}{ireallydontcare}[chapter]
\floatname{CodeFloat}{Code sample}
...
\newcommand{\codeColumnsBegin}[1]{
	...
	% doesn't work in float environment :(
	\def\columnseprulecolor{\color{CTU-lightblue}}
}
\newcommand{\codeColumnBreak}{
	\columnbreak
}
\newcommand{\codeColumnsEnd}[1]{
	\end{multicols}\normalsize
	\caption{\emph{#1}}
	\end{CodeFloat}
}
