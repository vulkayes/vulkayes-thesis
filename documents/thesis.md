...
The ultimate goal for Vulkayes to become a fully-featured rendering library and for a rendering engine to be built on top of it, eventually replacing the game engine based on Vulkano in&nbsp;[@FireTrail].
